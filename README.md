...
Projecto desenvolvido para a unidade curricular de Programação II.  
...
1. Fazer o build do projecto no Netbeans
2. Executar o `Main.java`
 
## Tecnologias usadas
 
- Java (sem dependências externas)
- Ficheiros de texto para persistência de dados
